...
// Simplified AIBrain for React (client-side only)
...
What would you like to explore today?`,
      ...
      capabilities: {
        patterns: ['what can you do', 'help', 'capabilities', 'features'],
...
How can I help you explore this topic further?`,
  ...
  learn(topic, response) {
    this.knowledgeBase[topic.toLowerCase()] = {
      patterns: topic.toLowerCase().split(' '),
      response: response,
      confidence: 85,
      learned: new Date().toISOString()
    };
    return { success: true, message: `✅ Learned about: ${topic}` };
  }
}
...
export default function AIBrainChat({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-black border border-white/20 rounded-2xl w-full max-w-4xl h-[700px] flex flex-col">
        {/* Header */}
        <div className="border-b border-white/10 p-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="p-2 hover:bg-white/5 rounded-lg transition disabled:opacity-30"
              title="Export chat"
            >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="text-center text-white/40 py-12">
              ...
              <div className="mt-6 text-sm text-white/60 max-w-md mx-auto">
